    ...
    <main className="min-h-screen bg-white py-8">
      <div className="container-custom max-w-4xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h1 className="text-2xl lg:text-4xl font-bold text-primary-900 mb-4 font-playfair">
        ...
        <div className="space-y-6">
          ...
          <section className="bg-white rounded-xl shadow-sm border border-primary-100 p-4">
            ...
            <p className="text-primary-700 mb-4 leading-relaxed font-poppins">
              ...
              , each piece is made to order with care. Because of the time and
              resources involved, we do not offer monetary refunds except in
              cases where the item arrives damaged.
            </p>

            <div className="bg-yellow-50 border border-yellow-200 p-3 rounded-lg">
              <p className="text-yellow-700 text-sm font-poppins">
                <strong className="font-playfair">Important:</strong> For
                damaged items, you must provide video evidence within 24 hours
                of receiving the item to our WhatsApp line.
              </p>
            </div>
          </section>
          ...
          <section className="bg-white rounded-xl shadow-sm border border-primary-100 p-4">
            ...
            <div className="bg-primary-50 p-4 rounded-lg border border-primary-200">
              <p className="text-primary-700 text-sm font-poppins">
                <strong className="font-playfair">Note:</strong> Exchanges
                accepted for the same style in a different size, or we can
                remake using your custom measurements. Customer is responsible
                for exchange shipping costs.
              </p>
            </div>
          </section>
          ...
          <section className="bg-white rounded-xl shadow-sm border border-primary-100 p-4">
            ...
            <div className="bg-red-50 p-4 rounded-lg border border-red-200">
              <p className="text-red-700 text-sm font-poppins">
                <strong className="font-playfair">Non-returnable:</strong>{" "}
                Custom orders and discounted items are not eligible for return
                or exchange.
              </p>
            </div>
          </section>
          ...
          <section className="bg-primary-50 rounded-xl border border-primary-200 p-6">
            ...
            <p className="text-primary-700 leading-relaxed font-poppins text-sm">
              Every <span className="font-playfair">Kavan</span> piece is made
              with care to reduce waste. Please double-check your size,
              measurements, and interest before placing an order. Your mindful
              shopping helps us limit packaging waste and reduce the carbon
              footprint of unnecessary returns—supporting a more thoughtful
              fashion ecosystem for both people and the planet.
            </p>
          </section>

          {/* Contact CTA */}
          <div className="bg-primary rounded-xl p-6 text-center">
            <h3 className="text-lg font-bold mb-2 font-playfair text-white">
              Need Help?
            </h3>
