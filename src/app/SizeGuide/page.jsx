    ...
    <main className="min-h-screen bg-white py-8">
      <div className="container-custom max-w-6xl mx-auto px-4">
        ...
        <div className="bg-primary-50 border-l-4 border-primary p-6 rounded-lg mb-8">
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-primary-700 font-poppins leading-relaxed">
        ...
        <section className="bg-white rounded-xl shadow-sm border border-primary-100 p-6 mb-8">
              ...
              <tbody className="divide-y divide-primary-100">
                {[
                  ...
                  >
                    ...
                    <td className="p-3 text-center text-primary-700 font-poppins text-sm">{row.bust}"</td>
                    <td className="p-3 text-center text-primary-700 font-poppins text-sm">{row.waist}"</td>
                    <td className="p-3 text-center text-primary-700 font-poppins text-sm">{row.hips}"</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="mt-4 text-sm text-primary-600 text-center font-poppins">
            ...
            <table className="w-full border-collapse">
              ...
              <tbody className="divide-y divide-primary-100">
                <tr className="hover:bg-primary-50 transition-colors duration-200 bg-white">
                  ...
                  <td className="p-3 text-center text-primary-700 font-poppins text-sm">42"</td>
                  <td className="p-3 text-center text-primary-700 font-poppins text-sm">45"</td>
                  <td className="p-3 text-center text-primary-700 font-poppins text-sm">47"</td>
                  <td className="p-3 text-center text-primary-700 font-poppins text-sm">52"</td>
                </tr>
                <tr className="hover:bg-primary-50 transition-colors duration-200 bg-primary-25">
                  ...
                  <td className="p-3 text-center text-primary-700 font-poppins text-sm">56"</td>
                  <td className="p-3 text-center text-primary-700 font-poppins text-sm">58"</td>
                  <td className="p-3 text-center text-primary-700 font-poppins text-sm">60"</td>
                  <td className="p-3 text-center text-primary-700 font-poppins text-sm">65"</td>
                </tr>
                <tr className="hover:bg-primary-50 transition-colors duration-200 bg-primary-25">
                  <td className="p-3 font-semibold text-primary font-playfair text-sm">DRESS LENGTH</td>
                  <td className="p-3 text-center text-primary-700 font-poppins text-sm">56"</td>
                  <td className="p-3 text-center text-primary-700 font-poppins text-sm">57"</td>
                  <td className="p-3 text-center text-primary-700 font-poppins text-sm">63"</td>
                  <td className="p-3 text-center text-primary-700 font-poppins text-sm">65"</td>
                </tr>
              </tbody>
            </table>
        ...
        <section className="bg-primary-50 rounded-xl border border-primary-200 p-6 mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-white p-4 rounded-lg border border-primary-100 hover:shadow-md transition-all duration-300">
              ...
              <p className="text-primary-700 text-sm text-center font-poppins leading-relaxed">
        ...
        <section className="bg-primary rounded-xl p-6 text-center">
          ...
          <p className="text-primary-100 text-base mb-4 max-w-2xl mx-auto font-poppins">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              href="/contact-us"
              className="inline-flex items-center justify-center bg-white text-primary hover:bg-primary-50 px-6 py-3 rounded-lg font-semibold transition-all duration-300 hover:scale-105 font-poppins"
            >
