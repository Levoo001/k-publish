      ...
      <div className="container-custom max-w-6xl mx-auto px-4">
        ...
        <div className="bg-primary-50 border-l-4 border-primary p-6 rounded-lg mb-8">
          <div className="flex items-start">
            <div className="text-xl mr-4 text-primary mt-1">💡</div>
            <div>
              <h3 className="text-lg font-semibold text-primary-900 mb-2 font-playfair">
                Finding Your Perfect Fit
              </h3>
              <p className="text-primary-700 font-cormorant leading-relaxed">
        ...
        {/* Size Guide Section */}
        <section className="bg-white rounded-xl shadow-sm border border-primary-100 p-6 mb-8">
            ...
            <table className="w-full border-collapse">
              ...
              <tbody className="divide-y divide-primary-100">
                {[
                  ...
                  >
                    <td className="p-3 font-semibold text-primary font-playfair text-sm">{row.size}</td>
                    <td className="p-3 text-center text-primary-700 font-cormorant text-sm">{row.bust}"</td>
                    <td className="p-3 text-center text-primary-700 font-cormorant text-sm">{row.waist}"</td>
                    <td className="p-3 text-center text-primary-700 font-cormorant text-sm">{row.hips}"</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="mt-4 text-sm text-primary-600 text-center font-cormorant">
            ...
            <table className="w-full border-collapse">
              <thead>
                ...
                <tr className="bg-primary-50">
                  <th className="p-2 text-left text-xs font-semibold text-primary-900 font-playfair">HEIGHT</th>
                  <th className="p-2 text-center text-xs font-semibold text-primary-900 font-playfair">5'0"-5'3FT</th>
                  <th className="p-2 text-center text-xs font-semibold text-primary-900 font-playfair">5'4"-5'7FT</th>
                  <th className="p-2 text-center text-xs font-semibold text-primary-900 font-playfair">5'8"-5'9FT</th>
                  <th className="p-2 text-center text-xs font-semibold text-primary-900 font-playfair">6FT+</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-primary-100">
                <tr className="hover:bg-primary-50 transition-colors duration-200 bg-white">
                  <td className="p-3 font-semibold text-primary font-playfair text-sm">PANTS/SKIRT LENGTH</td>
                  <td className="p-3 text-center text-primary-700 font-cormorant text-sm">42"</td>
                  <td className="p-3 text-center text-primary-700 font-cormorant text-sm">45"</td>
                  <td className="p-3 text-center text-primary-700 font-cormorant text-sm">47"</td>
                  <td className="p-3 text-center text-primary-700 font-cormorant text-sm">52"</td>
                </tr>
                <tr className="hover:bg-primary-50 transition-colors duration-200 bg-primary-25">
                  <td className="p-3 font-semibold text-primary font-playfair text-sm">DRESS LENGTH</td>
                  <td className="p-3 text-center text-primary-700 font-cormorant text-sm">56"</td>
                  <td className="p-3 text-center text-primary-700 font-cormorant text-sm">58"</td>
                  <td className="p-3 text-center text-primary-700 font-cormorant text-sm">60"</td>
                  <td className="p-3 text-center text-primary-700 font-cormorant text-sm">65"</td>
                </tr>
                <tr className="hover:bg-primary-50 transition-colors duration-200 bg-primary-25">
                  <td className="p-3 font-semibold text-primary font-playfair text-sm">DRESS LENGTH</td>
                  <td className="p-3 text-center text-primary-700 font-cormorant text-sm">56"</td>
                  <td className="p-3 text-center text-primary-700 font-cormorant text-sm">57"</td>
                  <td className="p-3 text-center text-primary-700 font-cormorant text-sm">63"</td>
                  <td className="p-3 text-center text-primary-700 font-cormorant text-sm">65"</td>
                </tr>
              </tbody>
            </table>
        ...
        <section className="bg-primary-50 rounded-xl border border-primary-200 p-6 mb-8">
          <div className="text-center mb-6">
            ...
            <h2 className="text-2xl font-bold mb-3 font-playfair text-primary-900">How to Measure</h2>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-white p-4 rounded-lg border border-primary-100 hover:shadow-md transition-all duration-300">
              ...
              <h3 className="font-semibold text-lg mb-2 text-center font-playfair text-primary-900">Bust</h3>
              <p className="text-primary-700 text-sm text-center font-cormorant leading-relaxed">
            ...
            <div className="bg-white p-4 rounded-lg border border-primary-100 hover:shadow-md transition-all duration-300">
              <div className="text-2xl mb-3 text-center text-primary">⏳</div>
              <h3 className="font-semibold text-lg mb-2 text-center font-playfair text-primary-900">Waist</h3>
              <p className="text-primary-700 text-sm text-center font-cormorant leading-relaxed">
            ...
            <div className="bg-white p-4 rounded-lg border border-primary-100 hover:shadow-md transition-all duration-300">
              <div className="text-2xl mb-3 text-center text-primary">🍐</div>
              <h3 className="font-semibold text-lg mb-2 text-center font-playfair text-primary-900">Hips</h3>
              <p className="text-primary-700 text-sm text-center font-cormorant leading-relaxed">
        ...
        <section className="bg-primary rounded-xl p-6 text-center">
          ...
          <p className="text-primary-100 text-base mb-4 max-w-2xl mx-auto font-cormorant">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              href="/contact-us"
              className="inline-flex items-center justify-center bg-white text-primary hover:bg-primary-50 px-6 py-3 rounded-lg font-semibold transition-all duration-300 hover:scale-105 font-inter"
            >
