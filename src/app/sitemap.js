...
const STATIC_ROUTES = [
  ...
  { url: `${BASE_URL}/collections/new-arrivals`, priority: 0.8, changeFrequency: "weekly" },
  ...
  { url: `${BASE_URL}/collections/sets`, priority: 0.7, changeFrequency: "weekly" },
  { url: `${BASE_URL}/collections/skirts`, priority: 0.7, changeFrequency: "weekly" },
  { url: `${BASE_URL}/collections/sale`, priority: 0.7, changeFrequency: "weekly" },
